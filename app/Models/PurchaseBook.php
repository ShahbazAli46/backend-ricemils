...
class PurchaseBook extends Model
{
    ...
    protected $fillable = [
       ...
       'freight','price','price_mann','bank_tax','total_amount','date','payment_type','cash_amount','cheque_amount','cheque_no','cheque_date','transection_id','net_amount','rem_amount','description'
    ];
